...
export default class ShowUnit extends React.Component {
      ...
      <PageHeaderLayout title='单元信息' >
        <Card bordered={false}>
          <DescriptionList col='1' style={{ marginBottom: 32 }}>
            ...
            <Description term="所属小区">{dataInfo.zone_name}</Description>
            <Description term="所属楼栋">{dataInfo.building_name}</Description>
